...
public final class ID implements Device_ID, Comparable<ID>, Serializable {
   ...
   public int compareTo(ID o) {
      var c=Long.compareUnsigned(getMac(), o.getMac());
      if (c != 0)
         return c;
      if (getIn4() instanceof Inet4Address i && o.getIn4() instanceof Inet4Address oi)
   ...
   static public String getMAC(long m) {
      var sb=new StringBuilder(Long.toHexString(m));
   ...
   public boolean isReachable() {
      if (in4 instanceof Inet4Address in4a)
         try {
   ...
   public String toString() {
      var sb=new StringBuilder(getName()); // else // sb.append(in4);
      if (mac != 0)
   ...
   public @NonNull String getHostName() {
      if (hostname == null)
         if (in4 instanceof Inet4Address in4a && in4a.getHostName() instanceof String hn)
            hostname=hn;
         else
            hostname="";
      return hostname;
