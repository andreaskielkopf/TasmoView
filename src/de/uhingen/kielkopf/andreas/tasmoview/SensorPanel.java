...
public class SensorPanel extends JPanel {
   ...
   private JPanel getRefreshPanel() {
      if (refreshPanel == null) {
         ...
         refreshPanel.setBorder(new TitledBorder(new LineBorder(new Color(184, 207, 229)), "Refresh",
                  TitledBorder.LEADING, TitledBorder.TOP, null, new Color(51, 51, 51)));
         final GridBagLayout gbl_refreshPanel=new GridBagLayout();
         ...
         final GridBagConstraints gbc_lblLastRead=new GridBagConstraints();
         ...
         final GridBagConstraints gbc_refreshLabel=new GridBagConstraints();
         ...
         final GridBagConstraints gbc_refreshSpinner=new GridBagConstraints();
         ...
         final GridBagConstraints gbc_lblSekunden=new GridBagConstraints();
         ...
         final GridBagConstraints gbc_lblLastSaved=new GridBagConstraints();
         ...
         final GridBagConstraints gbc_saveLabel=new GridBagConstraints();
         ...
         final GridBagConstraints gbc_saveSpinner=new GridBagConstraints();
         ...
         final GridBagConstraints gbc_lblMinuten=new GridBagConstraints();
